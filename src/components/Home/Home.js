...
export default class Home extends Component {
  render() {
    return (
      <div>
        <div className="container-fluid header-container p-2">
          <div className="row">
        ...
        <div className="container-fluid mt-2">
          <div className="d-flex flex-column flex-md-row justify-content-around align-items-center p-3">
            <div className="webure-card p-3 m-2">
              ...
              <p className="card-description">
                Webure gathers the complete requirement and assigns a dedicated
                person for the project who gives you regular updates with the
                project to customer.
              </p>
            ...
            <div className="webure-card p-3 m-2">
              ...
              <p className="card-description">
                ...
                friendly web interface to ensure seamless collaboration as your
                extended team for technology.
              </p>
              <a className="card-link" href="/">
                Learn More
              </a>
          ...
          <div className="row">
                ...
                <div className="m-3">
                  <div class="about-us-card p-3 mb-3 mt-5">
                    ...
                    <p class="card1-description">
                      We're motivated to scale and grow your business as we are
                      more than just a web application development company.
                      We're strong software development partner who is ready to
                      cover all your tech needs.
                    </p>
                  </div>
                </div>
                <div className="m-3">
            ...
            <div className="col-12 col-xl-6 pl-5 d-flex flex-column align-items-start justify-content-center">
              ...
              <p class="about-card-description">
                We offer the same services that thousands of others do. But the
                real difference is in the execution
              </p>
              <br />
              <p class="about-card-description">
          ...
          <div className="row pt-5 pb-5 pr-2 pl-2">
            <div className="col-12 mt-5">
              <h1 className="text-center pt-5">Why should you Choose Us</h1>
              <h5 className="text-center pb-3 choose-us-description">
                Webure a Full Service Agency that help our clients expand their
                digital reach
              </h5>
            </div>
            <div className="d-flex flex-column flex-md-row justify-content-around flex-wrap w-100">
              <div>
                <div class="choose-us-card p-3 mb-3">
                  <div className="text-center">
                    <img src={startup1} class="card-image" alt="startup1" />
                  </div>
                  <h1
                    class="choose-us-card-title mt-3"
                    style={{ color: '#f54b08' }}
                  >
                    Consult
                  </h1>
                  <p class="choose-us-card-description">
          ...
          <div className="col-12 pt-3 pb-3">
            <Marquee behavior="scroll" direction="left">
              <img className="move-img mr-5 ml-5" src={cmp1} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp2} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp3} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp4} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp1} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp2} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp3} alt="logo" />
              <img className="move-img mr-5 ml-5" src={cmp4} alt="logo" />
        ...
        <div className="pr-5 pl-5">
          <div className="row pb-3 digital-drive-container">
            <div className="col-12 mt-5 mb-5">
              <h1 className="text-center digital-drive-headings">
          ...
          <div className="row mb-5">
            <div className="col-12 mt-5">
              <h1 className="text-center pt-5 ready-to-heading">
                Ready to Grow Business?
              </h1>
              <h5 className="text-center pb-3 ready-to-description">
            ...
            <div className="d-flex flex-row justify-content-around w-100 flex-wrap">
              <div>
                <div class="ready-to-card p-3 mb-3 d-flex flex-column justify-content-around align-items-center">
                  <div>
                    <img
                      src={cmp1}
                      class="ready-to-card-stripe-image"
                      alt="cmp1"
                    />
                  </div>
                  <h1 class="ready-card-title mt-3">Stripe</h1>
                  <p class="ready-to-card-description">
              ...
              <div>
                <div class="ready-to-card p-3 mb-3 d-flex flex-column justify-content-around align-items-center">
                  <div>
                    <img src={cmp2} class="ready-to-card-image" alt="cmp2" />
                  </div>
                  <h1 class="ready-card-title mt-3">razorpay</h1>
                  <p class="ready-to-card-description">
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry.
                  </p>
              ...
              <div>
                <div class="ready-to-card p-3 mb-3 d-flex flex-column justify-content-around align-items-center">
                  <div>
                    <img src={cmp3} class="ready-to-card-image" alt="cmp3" />
                  </div>
                  <h1 class="ready-card-title mt-3">Slack</h1>
                  <p class="ready-to-card-description">
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry.
                  </p>
              ...
              <div>
                <div class="ready-to-card p-3 mb-3 d-flex flex-column justify-content-around align-items-center">
                  <div>
                    <img src={cmp4} class="ready-to-card-image" alt="cmp4" />
                  </div>
                  <h1 class="ready-card-title mt-3">Marketo</h1>
                  <p class="ready-to-card-description">
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry.
                  </p>
