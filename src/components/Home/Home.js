        ...
        return (
            ...
            <div className="container">
                <div className="row">
                    ...
                    <h1 class='text-left pt-5' >Webure a <strong style={{color:"#f54b08"}}> Full Service Digital Agency </strong> </h1>
            ...
            <div className="row" >
                ...
                <div className="row">
                    <div className="col-12 col-md-6 mb-3">
                        <h1 className="text-left" style={{color:"#f54b08"}}>Get in touch</h1>
